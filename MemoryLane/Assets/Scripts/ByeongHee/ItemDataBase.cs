...
public class ItemDataBase : MonoBehaviour {
	...
	void Start () {
        ...
        items.Add(new Item("Inside_C_04", "애기편지", 5, "힌트", 10, Item.ItemType.Hint));
        items.Add(new Item("iconset_04", "", 6, "힌트", 10, Item.ItemType.Hint));
        items.Add(new Item("그림10", "", 7, "힌트", 10, Item.ItemType.Hint));
        items.Add(new Item("ace_library_candacis_and_pandamaru 1", "상장", 8, "힌트", 10, Item.ItemType.Hint));
        items.Add(new Item("SketchBook 1", "꼬맹이 스케치북", 9, "힌트", 10, Item.ItemType.Hint));
    }
